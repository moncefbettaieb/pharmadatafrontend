          ...
          <div class="flow-root">
            <ul role="list" class="-my-6 divide-y divide-gray-200">
              ...
              >
                <!-- Image -->
                <div
                  class="h-24 w-full sm:w-24 flex-shrink-0 overflow-hidden rounded-md border border-gray-200"
                >
                  <img
                ...
                <div class="flex-1 flex flex-col justify-between">
                  <div>
                    <div
                      class="flex flex-col sm:flex-row justify-between text-base font-medium text-gray-900"
                    >
                  ...
                  <div
                    class="mt-4 flex flex-col sm:flex-row justify-between items-start sm:items-center text-sm"
                  >
                    <p class="text-gray-500">
                      Code Réferent (CIP ou EAN): {{ item.codereferent }}
                    </p>
                    <button
        ...
        <div class="mt-8 border-t border-gray-200 pt-8">
          ...
          >
            ...
            <div class="flex-1">
              ...
              >
                <p>Total</p>
                <p>{{ (cartStore.items.length * 0.7).toFixed(2) }}€</p>
              </div>
